...
#define NTY_RPOTO_BIND_CONFIRM_PUSH_JSON_LENGTH_IDX				(NTY_PROTO_BIND_CONFIRM_PUSH_MSGID_IDX+NTY_ACKNUM_LENGTH)
#define NTY_RPOTO_BIND_CONFIRM_PUSH_JSON_CONTENT_IDX			(NTY_RPOTO_BIND_CONFIRM_PUSH_JSON_LENGTH_IDX+2)
