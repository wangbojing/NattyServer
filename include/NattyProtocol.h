...
#define NTY_PROTO_QRCODE_REQ_DEVID_IDX				NTY_PROTO_DEVID_IDX
#define NTY_PROTO_QRCODE_REQ_JSON_LENGTH_IDX		(NTY_PROTO_QRCODE_REQ_DEVID_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_QRCODE_REQ_JSON_CONTENT_IDX		(NTY_PROTO_QRCODE_REQ_JSON_LENGTH_IDX+2)

#define NTY_PROTO_QRCODE_ACK_STATUS_IDX				NTY_PROTO_DEVID_IDX
#define NTY_PROTO_QRCODE_ACK_JSON_LENGTH_IDX		(NTY_PROTO_QRCODE_ACK_STATUS_IDX+2)			
#define NTY_PROTO_QRCODE_ACK_JSON_CONTENT_IDX		(NTY_PROTO_QRCODE_ACK_JSON_LENGTH_IDX+NTY_DEVID_LENGTH)
...
#define NTY_PROTO_BIND_AGREE_ACK_ADMIN_IDX				NTY_PROTO_DEVID_IDX
#define NTY_PROTO_BIND_AGREE_ACK_DEVICEID_IDX			(NTY_PROTO_BIND_AGREE_ACK_ADMIN_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_BIND_AGREE_ACK_MSGID_IDX				(NTY_PROTO_BIND_AGREE_ACK_DEVICEID_IDX+NTY_DEVID_LENGTH)
#define NTY_PROTO_BIND_AGREE_ACK_JSON_LENGTH_IDX		(NTY_PROTO_BIND_AGREE_ACK_MSGID_IDX+NTY_ACKNUM_LENGTH)
#define NTY_PROTO_BIND_AGREE_ACK_JSON_CONTENT_IDX		(NTY_PROTO_BIND_AGREE_ACK_JSON_LENGTH_IDX+2)
...
#define NTY_PROTO_BIND_ARGEE_REQ			0x61
#define NTY_PROTO_BIND_ARGEE_ACK			0xE1

#define NTY_PROTO_QRCODE_REQ				0x71
#define NTY_PROTO_QRCODE_ACK				0xF1
