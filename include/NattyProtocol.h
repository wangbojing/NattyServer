...
#define NTY_PROTO_P2PADDR_REQ_DEVID_IDX		(NTY_PROTO_MSGTYPE_IDX+1)
...
#define NTY_PROTO_UNBIND_TYPE_IDX				NTY_PROTO_MSGTYPE_IDX
...
#define NTY_PROTO_BIND_TYPE_IDX					NTY_PROTO_MSGTYPE_IDX
